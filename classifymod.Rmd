...
```{r e4, echo=TRUE, fig.cap="Variable importance plot from the final random forest model selected by caret for the Pima.tr dataset", fig.alt="Variable importance is indicated by the mean decrease in the Gini index", comment="", message=FALSE}
library(randomForest)
library(caret)
#cross-validation with 5 folds
train_control <- trainControl(method = "cv", number = 5) 
